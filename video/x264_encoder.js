...
var X264Encoder = (function () {
    ...
    X264Encoder.prototype.init = function (cfg) {
        ...
        this.x264_pic_u = _malloc(parseInt(width * height / 4));
        this.x264_pic_v = _malloc(parseInt(width * height / 4));
    ...
    X264Encoder.prototype.encode_frame = function () {
        ...
        _x264_picture_setup(this.x264_pic, 0x0001, this.frame_idx, this.width, parseInt(this.width / 2), parseInt(this.width / 2), this.x264_pic_y, this.x264_pic_u, this.x264_pic_v);
